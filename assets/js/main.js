...
document.getElementById("insert").onkeyup = function (event) {
    var osef = event.key.toUpperCase();
    if (allow.indexOf(osef) >= 0) {
        ...
        if (split.includes(event.key.toUpperCase())) {
            ...
            if (maxreponse == 0) {
                insert1.value = "";
                insert1.value = "Refresh la page";
                proposi.value = "Raté!";
                insert1.disabled = true;
                run.disabled = true;
                proposi.disabled = true;
                document.getElementById("refresh").setAttribute("class", "d-block");
...
document.getElementById("run").onclick = function () {
    if (motallea == proposi.value.toUpperCase()) {
        insert1.value = "Refresh la page";
        proposi.value = "Bravo c'est le bon mot !";
        document.getElementById("refresh").setAttribute("class", "d-block");
        document.getElementById("modal2").style.display = "block";
...
document.getElementById("close2").onclick = function () {
    document.getElementById("modal2").setAttribute("class", "d-none");
}
